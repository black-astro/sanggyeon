...
const MAX_PETALS = isMobile ? 30 : 60
const SPAWN_PROB = isMobile ? 0.14 : 0.24
...
.invite-card {
  ...
  box-shadow:
    ...
    0 2px 0 0 rgba(212,112,138,.3),
    0 32px 90px rgba(180,80,120,.1),
    0 8px 24px rgba(180,80,120,.07);
...
.hero-pattern {
  ...
  background-image:radial-gradient(circle at 50% 50%,rgba(255,192,210,1) 1px,transparent 1px);
...
.greeting-main { font-size:17.5px;font-weight:400;color:var(--text-main);line-height:2;margin-bottom:16px;word-break:keep-all; em{font-style:normal;color:var(--rose);font-weight:700} }
...
.family-grid {
  ...
  background:linear-gradient(135deg,rgba(255,192,210,.1),rgba(232,160,180,.05));
  border:1px solid rgba(212,112,138,.18);border-radius:4px;padding:26px 18px;
}
...
.and-circle {
  ...
  color:#fff;box-shadow:0 4px 18px rgba(180,80,120,.3);
}
